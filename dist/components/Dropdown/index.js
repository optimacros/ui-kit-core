...
import { w as oe, K as F, c as L, s as W, _ as ae, a as re, T as le, b as se, d as ce } from "../KeyCode-CgN7iLd1.js";
import * as K from "react";
import i, { forwardRef as fe, useMemo as ue } from "react";
import { K as ve } from "../KeyboardKeyList-CVetZNNA.js";
var de = F.ESC, me = F.TAB;
function he(e) {
  var n = e.visible, t = e.triggerRef, l = e.onVisibleChange, s = e.autoFocus, o = e.overlayRef, a = K.useRef(!1), c = function() {
    if (n) {
      var r, f;
...
function Ce(e, n) {
  var t, l = e.arrow, s = l === void 0 ? !1 : l, o = e.prefixCls, a = o === void 0 ? "rc-dropdown" : o, c = e.transitionName, p = e.animation, g = e.align, m = e.placement, r = m === void 0 ? "bottomLeft" : m, f = e.placements, H = f === void 0 ? ge : f, j = e.getPopupContainer, $ = e.showAction, G = e.hideAction, Y = e.overlayClassName, B = e.overlayStyle, I = e.visible, N = e.trigger, E = N === void 0 ? ["hover"] : N, U = e.autoFocus, A = e.overlay, b = e.children, O = e.onVisibleChange, X = ae(e, be), q = i.useState(), M = re(q, 2), z = M[0], k = M[1], V = "visible" in e ? I : z, P = i.useRef(null), _ = i.useRef(null), x = i.useRef(null);
  ...
  return !R && E.indexOf("contextMenu") !== -1 && (R = ["click"]), /* @__PURE__ */ i.createElement(le, se({
    ...
    prefixCls: a,
    ref: P,
    popupClassName: w(Y, ce({}, "".concat(a, "-show-arrow"), s)),
    popupStyle: B,
    action: E,
    showAction: $,
    hideAction: R,
...
const ye = /* @__PURE__ */ i.forwardRef(Ce), we = "Dropdown-module__Container__4KHHY", Oe = "Dropdown-module__Container__4KHHY", Ve = {
  Container: we,
  container: Oe
};
